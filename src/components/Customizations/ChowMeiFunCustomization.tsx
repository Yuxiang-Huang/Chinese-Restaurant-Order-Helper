...
const ChowMeiFunCustomization = ({
  ...
  const origAddPrice = calculuateAdditionalPrice(eggBoolean, dollarAmount);

  const save = () => {
    onEnter(
      id,
      calculuateAdditionalPrice(eggBoolean, dollarAmount) - origAddPrice,
...
const calculuateAdditionalPrice = (
  ...
  return (eggBoolean ? 1 : 0) + dollarAmount;
};

export default ChowMeiFunCustomization;
